...
export const Card: FunctionalComponent<Props> = (props) => {
    ...
    return (
        ...
        >
            {pulse && <div className={styles.pulse} onAnimationEnd={hidePulse} />}
            ...
            <div className={styles.back}>
                <div className={styles.content}>{props.back}</div>

                <div className={styles.close} data-cursor-focus={true} onClick={close}>
