    ...
    return (
        <PageSection id="about" title="About me">
            <div className={styles.about}>
                <p>
                    Hi! My name is Simon, and I&apos;m a Frontend Developer from Marburg / Germany who displays passion
                ...
                <article>
                    ...
                    <p>
                        ...
                        using{' '}
                        <Link href="https://www.oracle.com/java/technologies/javaserverfaces.html">
                            {' '}
                            Java Server Faces
                        </Link>{' '}
                        to a modern tech stack including <Link href="https://v3.vuejs.org/">Vue3</Link>. This includes
                        the evaluation of technologies to facilitate the transition and team-building.
                    </p>
                </article>
