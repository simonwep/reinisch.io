...
export const Presentations: FunctionalComponent = () => (
    <PageSection
        ...
        intro={
            <>
                Best two out of four presentations I&apos;ve created during high-school in Germany (Abitur). Both made
                using Vue / Preact in combination with <Link href="https://github.com/Simonwep/presentr">Presentr</Link>{' '}
                and <Link href="https://github.com/Simonwep/sassyfication">Sassyfication</Link>.
            </>
        }
    >
        <Presentation
